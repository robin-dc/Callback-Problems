...
answer:
cb1 - expects to return a boolean, if that condition is met
then manipulate the element using the
cb2. if the condition is not met, then just push the element into the new array

- What do you expect each callback function to be returning?

answer:
isEven - returns a boolean whether the element is a even number or not
isPositive - returns a boolean whether the element is greater than zero or more likely to be positive
flipSign - flips the sign of the element by multiplying into -1
square - multiplying the element by itself

- How many times are you calling each callback function?

answer: depends on the array length
*******************************************************************************/
