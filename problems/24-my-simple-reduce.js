...
Optional accumulator is also a parameter so i will set it to undefined and have a conditional statement.
If optional accumulator parameter is existing or not equal to undefined then i will set it as accumulator.
Otherwise, i will set the accumulator to the first element in the array.
*******************************************************************************/
